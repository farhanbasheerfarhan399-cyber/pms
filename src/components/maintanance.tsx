    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 md:gap-0">
          <h1 className="text-xl text-gray-600">Manage maintenance requests and repairs</h1>
          <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 w-full md:w-auto justify-center md:justify-start">
        ...
        <div className="bg-white rounded-lg shadow-sm">
          <div className="border-b border-gray-200">
            <div className="flex gap-8 px-4 md:px-6 overflow-x-auto scrollbar-hide">
              <button
          ...
          <div className="p-4 md:p-6">
            ...
            {activeTab === 'all' && (
              <div>
                <h2 className="text-2xl font-bold mb-6">All Maintenance Requests</h2>
            ...
            {activeTab === 'open' && (
              <div>
                ...
                <div className="space-y-4">
                  {filteredRequests.map((request) => (
                    <div key={request.id} className="border border-gray-200 rounded-lg p-4 md:p-6 hover:shadow-md transition-shadow">
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4 md:gap-0">
                        <div className="flex-1 w-full md:w-auto">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center">
                              Assign Technician
                            </button>
                            <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-center">
                              View Details
                            </button>
                          </div>
                        </div>
                        <div className="w-full md:w-auto flex flex-row md:flex-col justify-between md:items-end items-center">
            ...
            {activeTab === 'inProgress' && (
              <div>
                <h2 className="text-2xl font-bold mb-6">Requests In Progress</h2>
                <div className="overflow-x-auto">
                    ...
                    <tbody>
                      {filteredRequests.map((request) => (
                        <tr key={request.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-4 px-4 text-gray-700">{request.assignedTo}</td>
                          <td className="py-4 px-4">
                            <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg whitespace-nowrap">
                              Mark Complete
                            </button>
                          </td>
                        </tr>
